/* $OpenLDAP: pkg/ldap/libraries/libldap/util-int.c,v 1.17.8.7 2000/10/30 17:05:57 kurt Exp $ */
/*
...
# define NEED_COPY_HOSTENT   
	...
	*result = gethostbyname( (unsigned char *)name );
#else	
...
# define NEED_COPY_HOSTENT   
	...
	*buf = NULL;   
#if defined(__OS2__) && defined(TCPV40HDRS)	
	*result = gethostbyaddr( (unsigned char *)addr, len, type );
#else	
