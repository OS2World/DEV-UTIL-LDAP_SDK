/* $OpenLDAP: pkg/ldap/libraries/libldap/os-ip.c,v 1.33.2.13 2001/07/21 19:01:39 kurt Exp $ */
/*
...
//	}
	...
	if ( bsdselect(ldap_int_tblsize, z, &wfds,
#else
...
{
#if defined(__OS2__) && defined (TCPV40HDRS)
	unsigned long u = inet_addr( (char *)host );
#else	
