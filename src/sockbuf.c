...
/* $OpenLDAP: pkg/ldap/libraries/liblber/sockbuf.c,v 1.22.2.10 2001/05/06 19:53:58 kurt Exp $ */
/*
...
ber_pvt_socket_set_nonblock( ber_socket_t sd, int nb )
{
	...
	return ioctl( sd, FIONBIO, (unsigned char *)&status, sizeof(status) );
#else
 ...
 */
   ...
   defined( HAVE_WINSOCK ) || defined ( __BEOS__ ) || defined( __OS2__ )
/*
 * PCNFS (under DOS)
 */
/*
